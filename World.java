...
//import com.mhstudios.entities.Araucaria;
import com.mhstudios.entities.Bullet;
import com.mhstudios.entities.Enemy;
import com.mhstudios.entities.Entity;
import com.mhstudios.entities.Lifepack;
import com.mhstudios.entities.Player;
import com.mhstudios.entities.Weapon;
	...
	try {
		...
		for(int xx = 0; xx < map.getWidth(); xx++) {
			for(int yy = 0; yy <map.getHeight(); yy++) {
			 ...
			 }else if(pixelAtual == 0xFF870FFF) {
				 //player
				Game.player.setX(xx*16);
				Game.player.setY(yy*16);
			 }else if(pixelAtual == 0xFFF00052) {
			 ...
			 //}else if(pixelAtual == 0xFF005506){
				 //araucaria
				  //Game.entities.add(new Araucaria(xx*16, yy*16, 16, 16, Entity.ARAUCARIA_EN));
			 }
